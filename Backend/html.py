html1="""
            ...
            * {
            ...
            table, td { color: #000000; } @media (max-width: 480px) { #u_column_2 .v-col-border { border-top: 5px solid #8d95ff !important;border-left: 5px solid #8d95ff !important;border-right: 5px solid #8d95ff !important;border-bottom: 5px solid #8d95ff !important; } #u_content_text_2 .v-container-padding-padding { padding: 20px 10px 10px !important; } #u_content_text_3 .v-container-padding-padding { padding: 10px 10px 20px !important; } }
               </style>
            ...
            <div style="font-size: 14px; color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
               <p style="line-height: 140%;">Hemos recibido una solicitud para restablecer la contraseña de tu cuenta. Para ayudarte a acceder nuevamente te enviamos este código, el cual deberá utilizar para establecer una nueva contraseña.</p>
            <p style="line-height: 140%;"> </p>
            <p style="line-height: 140%;">Si no solicitaste este código, puedes comunicarte con nosotros a través de nuestro número de contacto.</p>
            <p style="line-height: 140%;"> </p>
            <p style="line-height: 140%;"> <strong>¡ Gracias por preferirnos!</strong><br /><br /></p>
            </div>
            ...
            <div style="font-size: 14px; color: #ffffff; line-height: 170%; text-align: center; word-wrap: break-word;">
               <p style="line-height: 170%;">   PRIVACY POLICY   |   WEB</p>
            <p style="line-height: 170%;"> </p>
            <p style="line-height: 170%;"> Enviamos este correo para informar cambios importantes, garantizando la seguridad de tu cuenta.</p>
            </div>
